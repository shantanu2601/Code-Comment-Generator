...
#SBATCH -o /scratch/bhanu/CodeCG-exp/outs/plnlspace-%j.out
#SBATCH -e /scratch/bhanu/CodeCG-exp/outs/plnlspace-%j.err
...
# Make folders 
mkdir "/scratch/bhanu/CodeCG-exp/saved_models/pl-encoders-$SLURM_JOB_ID"
...
--nl_en_model "/scratch/bhanu/CodeCG-exp/saved_models/nl-encoder-26103" \
--path_save_pl_encoder "/scratch/bhanu/CodeCG-exp/saved_models/pl-encoders-$SLURM_JOB_ID" \
--workers 4 \
--epochs 10 \
--batch_size 128 \
--g_lr 3e-4 \
